...
// @Autonomous(name = "MergiTATA", group = "Autonomous")
// public class MersInFata extends LinearOpMode {
...
// 		  motorManuta.setTargetPosition(1700);
...
// 		  {   
// 			 driveForward(-30); //merge in spate
...
// 			 motorManuta.setPower(-0.4);
// 			 motorManuta.setMode(DcMotor.RunMode.RUN_TO_POSITION);
// 			 rotate(-90, 0.7); //se invarte spre rata
