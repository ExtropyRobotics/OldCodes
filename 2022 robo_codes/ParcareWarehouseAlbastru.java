...
// @Autonomous(name = "ParcareAlbastruFinal", group = "Autonomous")
// public class ParcareAlbastruFinal extends LinearOpMode {
...
// 			 rotate(92,0.3);
// 			 driveForward(-45);
// 			 motorManuta.setTargetPosition(-1000); //-1000  //-1350
// 			 motorManuta.setPower(-0.25);
// 			 motorManuta.setMode(DcMotor.RunMode.RUN_TO_POSITION);
// 			 motorManuta.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
// 			 sleep(2200);
