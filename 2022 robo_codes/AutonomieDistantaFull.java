...
@Autonomous(name = "AutonomieDistantaFull", group = "Autonomous")
public class AutonomieDistantaFull extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    motorStangaSpate = hardwareMap.get(DcMotor.class, "motorStangaSpate");
	 ...
	 {
		  //driveForward(40);
		  telemetry.addData("CS1", CS1.getDistance(DistanceUnit.CM));
		  telemetry.addData("CS2", CS2.getDistance(DistanceUnit.CM));
		  telemetry.update();
    }    
}
