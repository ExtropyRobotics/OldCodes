...
//
//    Pose2d PlaceCon1 = new Pose2d(28      , -3      , Math.toRadians(132)); // splines to pole
//    Pose2d PlaceCon2 = new Pose2d(21.1    , -8.5    , Math.toRadians(90));
//    Pose2d PlaceCon3 = new Pose2d(21.3    , -8.4    , Math.toRadians(90)); // splines to pole
//    Pose2d PlaceCon4 = new Pose2d(21.2    , -7.6    , Math.toRadians(90));
//    Pose2d PlaceCon5 = new Pose2d(21.3    , -7.5    , Math.toRadians(90));
//
//    Pose2d PlaceConLine2 = new Pose2d(40 , -10   , Math.toRadians(0));
//    Pose2d PlaceConLine3 = new Pose2d(40 , -9   , Math.toRadians(0));
//    Pose2d PlaceConLine4 = new Pose2d(40 , -8   , Math.toRadians(0));
//
//    Pose2d TakeConSpline1 = new Pose2d(38 , -9      , Math.toRadians(0)); // from pole to a line
//    Pose2d TakeConSpline2 = new Pose2d(38 , -9      , Math.toRadians(0));
//    Pose2d TakeConSpline3 = new Pose2d(38 , -9      , Math.toRadians(0));
//    Pose2d TakeConSpline4 = new Pose2d(38 , -8.5    , Math.toRadians(0));
//
//    Pose2d TakeConLine1 = new Pose2d(52 , -10.2    , Math.toRadians(0)); // line to cone
//    Pose2d TakeConLine2 = new Pose2d(54 , -10.1    , Math.toRadians(0));
//    Pose2d TakeConLine3 = new Pose2d(54 , -9.2     , Math.toRadians(0));
//    Pose2d TakeConLine4 = new Pose2d(54 , -8.5     , Math.toRadians(0));
    ...
    Pose2d PlaceCon2 = new Pose2d(20.5 , -10.5      , Math.toRadians(90));
    Pose2d PlaceCon3 = new Pose2d(22.5  , -10.1      , Math.toRadians(90)); // splines to pole
    Pose2d PlaceCon4 = new Pose2d(24     , -10.4      , Math.toRadians(90));
    Pose2d PlaceCon5 = new Pose2d(25     , -10.3      , Math.toRadians(90));
    Pose2d PlaceCon6 = new Pose2d(25     , -10.8      , Math.toRadians(90));

    Pose2d PlaceConLine2 = new Pose2d(40 , -12.5   , Math.toRadians(0));
    Pose2d PlaceConLine3 = new Pose2d(40 , -13     , Math.toRadians(0));
    Pose2d PlaceConLine4 = new Pose2d(40 , -12.5   , Math.toRadians(0));
    Pose2d PlaceConLine5 = new Pose2d(40 , -12.5   , Math.toRadians(0));
    Pose2d PlaceConLine6 = new Pose2d(40 , -12     , Math.toRadians(0));

    Pose2d TakeConSpline1 = new Pose2d(38 , -12  , Math.toRadians(0)); // from pole to a line

    Pose2d TakeConLine1 = new Pose2d(51.25  , -13  , Math.toRadians(-5)); // line to cone
    Pose2d TakeConLine2 = new Pose2d(52.5   , -13    , Math.toRadians(0));
    Pose2d TakeConLine3 = new Pose2d(54.4   , -13.5  , Math.toRadians(0));
    Pose2d TakeConLine4 = new Pose2d(54.7   , -13.25    , Math.toRadians(0));
    Pose2d TakeConLine5 = new Pose2d(56     , -13.25    , Math.toRadians(0));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (tag!=null) {
            if (tag.id != 0) {
                ...
                if (tag.id == 7) {
                    parkPos = new Pose2d(11  , 0, Math.toRadians(-90));
                }
                if (tag.id == 6) {
                    parkPos = new Pose2d(36, 0, Math.toRadians(0));
                }
            }
        } else {
