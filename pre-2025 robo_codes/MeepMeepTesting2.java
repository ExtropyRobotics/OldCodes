...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        Pose2d PlaceCon2 = new Pose2d(21  , -10.5     , Math.toRadians(90));
        Pose2d PlaceCon3 = new Pose2d(23.5   , -10.1      , Math.toRadians(90)); // splines to pole
        Pose2d PlaceCon4 = new Pose2d(25.4   , -10.4      , Math.toRadians(90));
        Pose2d PlaceCon5 = new Pose2d(25.6   , -10.3      , Math.toRadians(90));
        Pose2d PlaceCon6 = new Pose2d(27.8     , -10.8      , Math.toRadians(90));
        ...
        Pose2d TakeConSpline1 = new Pose2d(38 , -12.5 , Math.toRadians(0)); // from pole to a line
        ...
        Pose2d TakeConLine3 = new Pose2d(54.2   , -14    , Math.toRadians(0));
        Pose2d TakeConLine4 = new Pose2d(54.5   , -13.5    , Math.toRadians(0));
        Pose2d TakeConLine5 = new Pose2d(55.9   , -13.5    , Math.toRadians(0));
