...
@Autonomous(name = "!!!!!!!!!!!AUTONOMIEstangaAlbastru")
@Config
public class autoAlbastruStanga extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        drive.setPoseEstimate(startPosAS);

        TrajectorySequence AS = drive.trajectorySequenceBuilder(startPosAS)
                .lineTo(pixelPlaceAS)
        ...
        waitForStart();
        drive.followTrajectorySequence(AS);
    }
